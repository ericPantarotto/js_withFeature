...
class UserRecipeView extends View {
  ...
  _addHandlerShowModal() {
    this._buttonOpen.addEventListener(
      'click',
      this.removeHiddenClass.bind(this)
    );
  }
  ...
  removeIngredient() {
    ...
    if (this._parentElementIngredients.childElementCount <= 1) {
      this._parentElementIngredients.querySelector(
        '.upload__inputs input:nth-child(1)'
      ).value =
        this._parentElementIngredients.querySelector(
          '.upload__inputs input:nth-child(2)'
        ).value =
        this._parentElementIngredients.querySelector(
          '.upload__inputs input:nth-child(3)'
        ).value =
          '';
      return;
    }
